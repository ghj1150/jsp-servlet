...
<body>
    <div class="wrap">
        ...
        <main class="container">
            ...
            <form name = "frm"class="mx-auto col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 card p-2 mt-5">
                ...
                <input type="text" class="form-control my-3" id="name" placeholder="상세주소" name="email">
