...
<body>
    <div class="wrap">
        ...
        <div class="my-3 col-md-9 mx-auto">
                ...
                <input type="text" class="form-control" id="writer" placeholder="writer" name="writer" value="${post.writer}" disabled></textarea>

                <label for="regdate" class="form-label mt-3"><i class="fa-solid fa-clock text-danger"></i> <b>Register Date</b></label>
                <input type="text" class="form-control" id="regdate" placeholder="regdate" name="regdate" value="${post.regdate}" disabled></textarea>

                <label for="updatedate" class="form-label mt-3"><i class="fa-regular fa-clock text-danger"></i> <b>Updated Date</b></label>
                <input type="text" class="form-control" id="updatedate" placeholder="updatedate" name="updatedate" value="${post.updatedate}" disabled></textarea>
